                ...
                <div class="blog-featured_post">
                    ...
                    <?php foreach ($populer->result() as $row) :?>
                      <div class="blog-featured-img_block">
                          ...
                          <h5><a href="<?php echo site_url('artikel/'.$row->tulisan_slug);?>"><?php echo $controller->limit_words($row->tulisan_judul,3).'...';?></a></h5>
                          <p><?php echo $controller->limit_words($row->tulisan_isi,5).'...';?></p>
                      </div>
                      <hr>
                    <?php endforeach;?>
                </div>
